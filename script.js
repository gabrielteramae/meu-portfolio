...
Eventos: AWS Summit São Paulo 2026 (maior evento da AWS na América Latina, sessões sobre o futuro da IA, dados e modernização de infraestrutura, com destaque para a evolução das IAs conversacionais para IAs agênticas), O Custo da IA - Estratégias para Escalar sem Explodir o Budget (Cubo Itaú, com a Oracle, sobre arquitetura, infraestrutura, engenharia de dados, governança e otimização de recursos para escalar IA), Itaú Carreiras 2026 (reflexões sobre carreira, cultura e mercado financeiro, e conhecimento do novo Programa de Estágio do Itaú), Semana de Produtos Itaú 2026 (IA aplicada a produtos e experiências), C6 Tech Week 2026 (arquitetura de sistemas, IA na experiência do cliente e prevenção de fraudes), LLMs eficientes: custo, contexto e arquitetura — evento no Cubo Itaú em parceria com a Microsoft, com foco em como arquitetura, gestão de contexto e model routing impactam custo e performance em soluções com LLMs
